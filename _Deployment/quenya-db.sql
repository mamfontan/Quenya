...
-- Tiempo de generación: 06-12-2020 a las 15:27:05
...
CREATE TABLE IF NOT EXISTS `daily` (
  ...
  `openvalue` float NOT NULL DEFAULT '0',
  `closevalue` float NOT NULL DEFAULT '0',
...
INSERT INTO `stocks` (`code`, `name`, `country`, `currency`) VALUES
('BABA', 'Alibaba Group Holding Limited', 'United States', 'USD'),
('MSFT', 'Microsoft Corporation', 'United States', 'USD'),
('SAN', 'Banco Santander, S.A.', 'United States', 'USD'),
('SNAP', 'Snap Inc.', 'United States', 'USD'),
